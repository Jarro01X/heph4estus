...
output "nats_url" {
  ...
  value       = "${module.controller.nats_tls_enabled ? "tls" : "nats"}://${module.controller.nats_user}:${module.controller.nats_password}@${hcloud_server.controller.ipv4_address}:4222"
  sensitive   = true
}
