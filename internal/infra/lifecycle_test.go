...
func hetznerOutputs(tool string) string {
	return fmt.Sprintf(`{
		...
		"credential_scope_version":{"value":"nats-minio-registry-role-v1"},
		...
		"nats_mtls_enabled":{"value":"false"},
		"nats_auth_enabled":{"value":"true"},
		"nats_operator_client_cert_pem":{"value":"operator-cert"},
		"nats_operator_client_cert_not_after":{"value":"2027-05-03T00:00:00Z"},
		"nats_operator_client_key_pem":{"value":"operator-key"},
		"nats_worker_client_cert_not_after":{"value":"2027-05-03T00:00:00Z"},
		"s3_endpoint":{"value":"http://10.0.1.2:9000"},
		"s3_access_key":{"value":"admin"},
		"s3_secret_key":{"value":"secret"},
		"s3_operator_access_key":{"value":"operator"},
		"s3_operator_secret_key":{"value":"operator-secret"},
		...
		"registry_username":{"value":"publisher"},
		"registry_password":{"value":"publisher-secret"},
		"registry_publisher_username":{"value":"publisher"},
		"registry_publisher_password":{"value":"publisher-secret"},
		"registry_tls_enabled":{"value":"false"},
		"registry_auth_enabled":{"value":"true"},
